...
public final class WorkspaceFolderManager {
	...
	public File[] getHorseArmorTextureFilesForName(String horseArmorTextureName) {
		return new File[] { new File(getTexturesFolder(TextureType.OTHER), "horse_armor_" + horseArmorTextureName + ".png") };
	}
